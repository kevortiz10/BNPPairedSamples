...
This section presents a brief example of the use of the BNP.test,  plot.shift.function and the contours.plot functions.
...
```{r bnp3}
plot.shift.function(results_BNP=results)
```
